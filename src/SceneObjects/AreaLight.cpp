...
//	cout << "sample_point: " << sample_point.x << " " << sample_point.y << " " << sample_point.z << endl;
...
//	cout << "-light_normal: " << -light_normal.x << " " << -light_normal.y << " " << -light_normal.z << endl;
//	cout << "wi: " << wi.x << " " << wi.y << " " << wi.z << endl;
//	cout << "ndotd: " << ndotd << endl << "d2: " << d2 << endl;
	return (ndotd / d2);
}
...
//	cout << "arealight pdf" << endl;
	return (object_ptr->pdf(sr));
}


bool
AreaLight::casts_shadows(void){
	return true;
}
